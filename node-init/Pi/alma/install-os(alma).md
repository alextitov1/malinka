...
```sh
curl -OL https://repo.almalinux.org/almalinux/9/raspberrypi/images/AlmaLinux-9-RaspberryPi-gpt-latest.aarch64.raw.xz
```
...
xzcat AlmaLinux-9-RaspberryPi-gpt-latest.aarch64.raw.xz | sudo dd of=/dev/disk4 bs=4M status=progress conv=fsync

# linux
apt install -y xz-utils
xzcat AlmaLinux-9-RaspberryPi-gpt-latest.aarch64.raw.xz | dd of=/dev/nvme0n1 bs=4M status=progress conv=fsync
```
...
## Pi5 only, disable USB power limit, required to boot from USB-SATA adapter
